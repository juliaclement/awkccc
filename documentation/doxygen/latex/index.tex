...
If you are looking for a working AWK to Python transpiler, you are a bit early. The \href{https://github.com/juliaclement/awktopython}{\texttt{ awktopython project}} is still available and supports a large subset of AWK.\hypertarget{index_autotoc_md2}{}\doxysection{Status}\label{index_autotoc_md2}
